        ...
        // 4. Handle Text (Questions/Chat)
            ...
            try {
                if (!textBody || textBody.toLowerCase().match(/^(hi|hello|hey|namaste|namaskar|\/start)$/)) {
                    ...
                    sendAudioInBackground(chatId, `Namaste ${profileName}! I am Alzhal. Send me a photo of any product label, and I will tell you if it is safe. You can also ask me about specific ingredients.`, 'English', hashedId)
                } else {
